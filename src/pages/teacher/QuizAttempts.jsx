...
const QuizAttempts = () => {
  ...
  useEffect(() => {
    ...
    fetchAttempts();
  }, [ selectedStudent, selectedQuiz, currentPage ]);
            ...
            <div className="bg-white shadow-lg rounded-xl mt-8 p-6">
              ...
              {(selectedStudent || selectedQuiz) && (
                <div className="mt-5 flex items-center gap-3 flex-wrap">
                  {selectedStudent && (
                    <span className="bg-blue-100 text-blue-700 px-3 py-2 rounded-lg"> Student: {selectedStudent}</span>
                  )}
                  {selectedQuiz && (
                    <span className="bg-green-100 text-green-700 px-3 py-2 rounded-lg">Quiz: {selectedQuiz}</span>
                  )}
                  <button
